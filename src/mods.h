...
#define VERS_STRING  "0.30b "   // version for monitor (exact 6 chars)
#define VERS_STRING_ "0.30b"    // version for startup string (any length)
#define VER_HL 0x001E           // major version
