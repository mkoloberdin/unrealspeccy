...
#define VERS_STRING  "0.36.5"   // version for monitor (exact 6 chars)
#define VERS_STRING_ "0.36.5"    // version for startup string (any length)
#define VER_HL 0x0024           // major version
#define VER_A  0x05             // minor version and beta flag
